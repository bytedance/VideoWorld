...
# class Zero_classifier(object):
#     def __init__(self,token_config=""):
#         try:
#             from transformers import AutoTokenizer
#         except (ImportError, ModuleNotFoundError):
#             raise ImportError("Please install transformers >=4.0.0 to use this backbone.")
#
#         assert isinstance(token_config,str), f'Autokenizer must has pretrained models, but get {token_config}'
#         self.tokenizer = AutoTokenizer.from_pretrained(token_config,**kwargs)
#
...
#
#
# def build_sentence(imagenet_classnames,templates):
#     tokenize =
#     for classname in imagenet_classnames:
