...
from .mae_utils import resize_pos_embed, BEiTAttention, resize_relative_position_bias_table
from .mae_vit import MVisionTransformer, TransformerEncoderLayer
...
class BEITViT(MVisionTransformer):
    def __init__(self,
                 arch='base',
                 img_size=224,
                 patch_size=16,
