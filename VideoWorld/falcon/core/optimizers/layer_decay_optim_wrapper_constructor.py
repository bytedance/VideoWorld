...
from falcon.registry import OPTIM_WRAPPER_CONSTRUCTORS
...
@OPTIM_WRAPPER_CONSTRUCTORS.register_module()
class LearningRateRVDecayOptimWrapperConstructor(DefaultOptimWrapperConstructor):
    """Different learning rates are set for different layers of backbone.
