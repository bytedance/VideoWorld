...
class VideoResizer(PRNGMixin):
    ...
    def __call__(self, data):
        ...
        if isinstance(frames, int):
            frames = [torch.zeros(224, 224, 3).numpy() for _ in range(16)]
            data[vidkey] = frames
            data['pad_masks'] = torch.zeros(16)
            data['native_fps'] = 1
            data['start_frame'] = 0
            data['original_height'] = torch.ones(16)*224
            data['original_width'] = torch.ones(16)*224
            data['fps_id'] = torch.zeros(16)
